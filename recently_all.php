...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-top:5px;">Recently Added</h1>
      <nav>
        <!-- <ol class="breadcrumb">
    ...
    <section class="section dashboard">
        ...
        <div class="row" id="book-list">
            ...
            <?php
              ...
              $sql = "SELECT book_tbl.BookID, book_tbl.Title, book_tbl.BookDescription,  book_tbl.BookImage,  book_tbl.DateRegistered, author_tbl.AuthorName  
                      FROM book_tbl 
                      INNER JOIN author_tbl ON book_tbl.AuthorID = author_tbl.AuthorID
                      WHERE book_tbl.DateRegistered >= '$fiveDaysAgo' OR book_tbl.DateRegistered < '$fiveDaysAgo' ORDER BY book_tbl.DateRegistered DESC LIMIT 12 ";
