            ...
            <div class="card-body">
              <table class="table table-bordered text-center" style="margin-top:30px;">
                ...
                <?php
                    ...
                    $sql = "SELECT borrow_tbl.UserID, reservation_tbl.ReservationID, reservation_tbl.BookID, book_tbl.Title, borrow_tbl.PenaltyAmount, borrow_tbl.DueDate, borrow_tbl.StatusReturn, borrow_tbl.PenaltyStatus
                    FROM `borrow_tbl` 
                    ...
                    WHERE borrow_tbl.UserID = $user_id AND borrow_tbl.PenaltyStatus = 'Unpaid' AND borrow_tbl.PenaltyAmount > 0.00";
