...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-top:5px;">Highest Rated</h1>
      <nav>
        <!-- <ol class="breadcrumb">
    ...
    <section class="section dashboard">
        ...
        <?php
          ...
          $sql = "SELECT book_tbl.BookID, book_tbl.Title, book_tbl.BookImage, author_tbl.AuthorName
                  FROM book_tbl
                  ...
                  HAVING COUNT(review_tbl.ReviewID) > 0
                  ORDER BY COUNT(review_tbl.ReviewID) DESC";  
