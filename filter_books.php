...
if (isset($_GET['genre'])) {
    ...
    $sql = "SELECT book_tbl.BookID, book_tbl.Title, book_tbl.BookImage, author_tbl.AuthorName, genre_tbl.GenreName, bookCopy_tbl.CopyID,
            bookCopy_tbl.availability 
            FROM book_tbl
            ...
            WHERE GenreName LIKE '%$selectedGenre%'
